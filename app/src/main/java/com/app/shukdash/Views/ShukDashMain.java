...
public class ShukDashMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TabLayout.Tab firstTab = tabLayout.newTab().setText("FirstTAb").setCustomView(R.id.tabcat1);
        tabLayout.setSelectedTabIndicatorColor(Color.CYAN);



        special.setCustomView(firstTabCustomV);
        special.setText("Special");
        meetGreet.setText("MeetAndGreet");
        meetGreet.setCustomView(secondTabCustomV);
        shuktionary.setText("Shuktionary");
        shuktionary.setCustomView(thirdTabCustomV);
        navigate.setText("Navigate");
        navigate.setCustomView(forthTabCustomV);
        snap.setText("SNAP");
        snap.setCustomView(fifthTabCustomV);
        perform.setText("Performing Arts");
        perform.setCustomView(sixthTabCustomV);
